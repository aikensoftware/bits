      ...
      <div class="login-box">
        ...
        <div class="login-box-body">
          <div class="login-logo" style="margin-bottom:5px;">
            <img src="{url}assets/images/logo.jpg" width="50" height="53" /> <strong style="color:#333333;">e - Wisudawan</strong>
          </div>
          <section class="login_content">
            ...
            <form action="{url}admin/auth" method="post">
              ...
              <div class="form-group has-feedback">
                <input type="text" name="id" class="form-control has-feedback" placeholder="Username..." required="" />
              ...
              <div class="separator">
                <div>
                  <p><strong>e-Wisudawan <i class="fa fa-copyright"></i> 2017</strong> <br>
					<small><strong>Institut Saints dan Teknologi Al-Kamal</strong></small>
				  </p>
                </div>
              </div>
            </form>
