	...
	<?php
		if(!isset($action)){
			$action=site_url("pelanggan/save");
		}
	?>
        <h3 class="page-header"  style="margin-top:0px">Form Pelanggan <?php echo $button ?></h3>
	    ...
	    <div class="form-group">
			...
			<?php
				...
				$dt_layanan = $this->db->query("select * from tag_layanan where id_patner = $id_patner order by urutan asc ");
				if(isset($dt_layanan)){
