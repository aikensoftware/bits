...
class General_model extends CI_Model {
	...
	public function sidebarMenu()
	{
		...
		if($ss['ss_idagen'] == 0){
			$menu_admin = '<li id="baligh"><a href="'.site_url('pelanggan/create_tagihan').'"><i class="fa fa-file-text-o"></i> Buat Faktur Tagihan admin </a></li>
							<li>
								<a><i class="fa fa-file-text-o"></i> Master Data <span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu">
									<li id="baligh"><a href="'.site_url('agen').'"> Data Patner</a></li>                	
								</ul>
							</li>
							
							';
		}else if($ss['ss_idpatner'] == 0 && $ss['ss_idagen'] > 0){
			$menu_admin = '
							<li>
								<a><i class="fa fa-file-text-o"></i> Master Data <span class="fa fa-chevron-down"></span></a>
								<ul class="nav child_menu">
			...
			$menu_admin = '
							...
							<li id="baligh"><a href="'.site_url('layanan').'"><i class="fa fa-file-text-o"></i> Layanan</a></li>                	
							<li id="baligh"><a href="'.site_url('uang_jenis').'"><i class="fa fa-money"></i> Nama Akun </a></li>                	
							<li id="baligh"><a href="'.site_url('uang_masuk').'"><i class="fa fa-money"></i> Uang Masuk </a></li>                	
							<li id="baligh"><a href="'.site_url('uang_keluar').'"><i class="fa fa-money"></i> Uang Keluar </a></li>                	
							';
		}
			  ...
			  <div class="nav_menu" >
				<nav>
				  ...
				  <ul class="nav navbar-nav navbar-right">
 					...
 					<li class="dropdown">
		                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-user"></i> Profile '.$nama.'<span class="caret"></span></a>
		                <ul class="dropdown-menu">
							<li>
							  <a href="'.site_url("dashboard/edit_profile").'" class="user-profile">
								<i class="glyphicon glyphicon-edit"></i> Ganti Profile
							  </a>
							</li>
		   					<li>
	...
	public function display_edit_profile()
	{
		...
		$data_patner = $this->db->get('patner')->row();
		...
		$dsb = '<form method="post" action="'.site_url("dashboard/save_profile").'" enctype="multipart/form-data">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<table class="table table-condensed">
						...
						<tr>
							<td bgcolor="#eeeeee"><strong>Alamat</strong></td>
							<td><input type="alamat" name="alamat" class="form-control" value="'.$data_patner->alamat.'" placeholder="Alamat ..." /></td>
						</tr>
						<tr>
							<td bgcolor="#eeeeee"><strong>No Telp</strong></td>
							<td><input type="telp" name="telp" class="form-control" value="'.$data_patner->telp.'" placeholder="No Telp ..." /></td>
						</tr>
						<tr>
							<td bgcolor="#eeeeee"><strong>Email</strong></td>
							<td><input type="email" name="email" class="form-control" value="'.$ss['ista_adminemail'].'" placeholder="Email..." /></td>
						</tr>
